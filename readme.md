...
During the gameplay, you could perform a "Marco!" shoutout and to explore through a maze to find the source of the respond sound, leveraging mainly on the spatial audio cues.\
